 ...
 */
 const { replaceReactTranslations } = require('./transform-react');
 const constants = require('generator-jhipster/generators/generator-constants');
 const  authenticationTypes = require('generator-jhipster/jdl/jhipster/authentication-types');
 const  applicationTypes = require('generator-jhipster/jdl/jhipster/application-types');
 const  websocketTypes = require('generator-jhipster/jdl/jhipster/websocket-types');
